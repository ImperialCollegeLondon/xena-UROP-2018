...
-/
    have eq_210 : (210 : ℤ) = (2 : ℕ) * (105 : ℕ), by norm_num,
    have : legendre_sym 210 H1 = -1, {
...
/-
    exact calc 
    legendre_sym 210 H1 = legendre_sym (2*3*5*7) H1 : by rw eq_210
                ...
                ... = (legendre_sym 2 H1)*(legendre_sym 3 H1)*(legendre_sym 5 H1)*(legendre_sym 7 H1) : by rw [legendre_sym_mul,legendre_sym_mul,legendre_sym_mul,legendre_sym_mul]

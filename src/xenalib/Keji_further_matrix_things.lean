...
lemma L1 {n : ℕ} {R : Type} [comm_ring R] (A : matrix R n n) (σ : equiv.perm (fin n)) (ρ : equiv.perm (fin n)) :
...
finset.sum (finset.univ : finset ( equiv.perm (fin n))) (λ (σ : equiv.perm (fin n)), e σ *
 ...
 lemma L3 {n : ℕ} {R : Type} [comm_ring R] (A : matrix R n n) : finset.sum (finset.univ : finset (equiv.perm (fin n))) (λ (σ : equiv.perm (fin n)), e σ  *
...
lemma M1 {n : ℕ} {R : Type} [comm_ring R] [decidable_eq R] (A : matrix R n n) (ρ : equiv.perm (fin n)) :
finset.sum (finset.univ : finset ( equiv.perm (fin n))) (λ (σ : equiv.perm (fin n)), e σ * (finset.prod (finset.univ : finset (fin n)) 

...
have h4 : side (l a b) c p,
  exact (nine19 (six14 (six26 h).1) (six17a a b) (or.inl h2.symm)).2 ⟨(six7 h2 h_2).symm, h⟩,
...
have h4 : x ≠ a,
  intro h_1,
  subst x,
  exact (eleven45a h3.1).1 ⟨(six26 h2).2.2.symm, (six26 h2).1.symm, h1.2.2.2.2 c b (six17a c a) (six17b a b)⟩,
have h5 : x ≠ b,
  intro h_1,
  subst x,
  exact (eleven45a h3.2).1 ⟨(six26 h2).2.1.symm, h4.symm, h1.2.2.2.2 c a (six17a c b) (six17a a b)⟩,
refine ⟨_, h4, h5⟩,
  ...
  suffices : ¬col x c a,
    exact five6 (eleven46 this (or.inl (h1.2.2.2.2 c a (six17a c x) (six17a a b)))).2.1 (two5 (eqd.refl x a)) (eqd.refl c a),
  intro h_1,
...
exact ⟨h1, h2.flip, 
(eleven4.1 h).2.2.2.2 a c a' c' (six5 h.1) (six5 h.2.1) (six5 h.2.2.1) (six5 h.2.2.2.1) h1.flip h2.flip⟩
end
...
have h4 : cong a b c a' b' x,
  ...
  exact (eleven4.1 h1).2.2.2.2 b c b' x (six5 h1.1) (six5 h1.2.1) (six5 h1.2.2.1) hx.1 h3 hx.2.symm,
suffices : x = c',
  subst x,
...
suffices : sided b' x c',
  ...
  rw h_1,
  exact six17a b' c',
apply eleven15b h h5 x c' (eleven11 h2.1 h2.2.1 h4) _ h2 (side.refla (four10 h5).2.1),
apply ((nine19 (six14 h1.2.2.1) (six17b b' a') _).2 ⟨hx.1.symm, (four10 h5).2.1⟩).symm,
exact (four11 (six4.1 hx.1).1).2.2.2.1
end
...
have h4 : cong a b c a' b' x,
  ...
  exact (eleven4.1 h2).2.2.2.2 a c a' x (six5 h2.1) (six5 h2.2.1) (six5 h2.2.2.1) hx.1 h3.flip hx.2.symm,
suffices : x = c',
  subst x,
...
have h4 : cong a b c x b' c',
  ...
  exact (eleven4.1 h).2.2.2.2 a c x c' (six5 h.1) (six5 h.2.1) hx.1 (six5 h.2.2.2.1) hx.2.symm h2,
have h5 : a ≠ c,
  intro h_1,
  subst c,
  exact h.1.symm (id_eqd b a a (five9 h3 (five11 a b a))),
suffices : x = a',
  subst x,

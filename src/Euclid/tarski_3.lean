...
cases hu with v hv,
  ...
  rw ←h1 at *,
  rw hv.2 at *,
  have h2 := hx.2.2.2.2 v v (six17b x v) (six17b x v),
  exact hv.1 (eight8 h2).symm,
rw ←h1 at *,
  rw hv.2 at *,
  have h2 := hx.2.2.2.2 u u (six17a u v) (six17a u v),
exact h (eight8 h2)
end
...
split,
  ...
  apply R.symm,  
  exact h5.2.2.2.2 u c h2 (six17a c x),
intro h4,
cases h4 with h4 h5,
have h_1 : c ≠ x,
  intro h_1,
...
cases em (col a b c) with habc h,
  ...
  unfold xperp at h2,
  have h3 := h2.2.2.2.2 a c' (six17a a b) (six17a c' x),
  unfold R at h3,
  have h4 := seven5 a c',
  cases seven25 (eqd.trans h4.2.symm h3) with p hp,
  have h5 := eight20 (h2.2.2.2.2 a c' (six17a a b) (six17a c' x)) hp,
...
cases pasch p b q t r ht.2.2 hr.1 with x hx,
have h1 : col a b x,
  have h_1 : col b t x,
    right, left,
    exact hx.1,
...
have h4 := h2.2.2.2.2 b p (six17b a b) (six17a p a),
have h5 := h3.2.2.2.2 a q (six17b b a) (six17a q b),
have h6 : R a b r,
  have : col b q r,
    right, left,
    exact hr.1.symm,
...
have h8 : ¬col a b r,
  ...
  cases eight9 h6 h_1,
    exact h h_2,
  rw h_2 at *,
  exact (six13 h2.2.1).symm (id_eqd a p b hr.2),

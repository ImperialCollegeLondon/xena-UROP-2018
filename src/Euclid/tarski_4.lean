...
begin
unfold Bl at h2,
let g2 := six18 h2.1 (ne.symm h_1) h5 h3,
have g3 : (l s r) ⊥ (l c s),
  rwa g2 at h6,
have g4 : (l s r) ⊥ (l a r),
  rwa g2 at h4,
...
cases h_2 with b gb,
cases eight24 g3.symm g4.symm g5 ht.2.symm gb.1 gb.2 with m hm,
let h7 := nine4a h3 h4 h5 h6 h2 ht h_1 ⟨b, gb⟩ hm.1.symm,
unfold Bl at h2,
intros u v hu hv,
let h8 := (h7 u).1 hu,
...
cases em (r = s),
  ...
  have h_3 : xperp s (l c s) A,
    ...
    simp,
    exact h5,
  let h_4 := h_2.2.2.2.2 a t (six17a a r) ht.1,
  let h_5 := h_3.2.2.2.2 c t (six17a c s) ht.1,
  subst h,
  have h_6 : r = t,
...
let h7 := nine4a h5 h6 h3 h4 h2.symm ⟨ht.1, ht.2.symm⟩ (ne.symm h) ⟨b, gb⟩ hm.1.symm,
split,
  intro h_2,
  have h_3 : m' = m,
...
have h7 : c ≠ z,
  ...
  rw h_1,
  exact hz.1.1,
let h8 := nine4 h hx.1.1 hx.1.2 hz.1.1 hz.1.2,
...
let h14 := hz.1,
rw h13 at h14,
let h15 := (nine4 h11 hy.1.1 hy.1.2 h14.1 h14.2).2 b c (six5 h6) h9.symm,
exact h15,
exact a
end
...
split,
  ...
  split,
    ...
    suffices : A = l a b,
      ...
      apply h3.2.1,
      simp,
    apply six21 h_1 h (six14 (nine2 h3)) h1 h2 hq.1,
    right, left,
    exact hq.2.symm,
  split,
    exact h3.2.1,
...
have h5 : l a c = l a (S a c),
  apply six18 (six14 (six26 h).2.2),
    exact seven12 (six26 h).2.2,
    simp,
  right, right,
  exact h1.1.symm,
unfold planeof,
let h6 := (nine8 h3).2 hx.symm,
